package com.company.security.inmemory.security;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity security) throws Exception {
        security
                ...
                // .formLogin(Customizer.withDefaults()) default login sayfasi olur
                .formLogin(AbstractHttpConfigurer::disable) //username passwordu headerla yollayiriq
